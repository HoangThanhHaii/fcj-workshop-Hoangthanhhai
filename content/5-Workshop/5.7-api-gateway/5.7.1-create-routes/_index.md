...
![Cognito flow](/fcj-workshop-Hoangthanhhai/images/5-Workshop/service-image/1.571.png)
2. Choose **Create API**.
![Cognito flow](/fcj-workshop-Hoangthanhhai/images/5-Workshop/service-image/1.571.png)
3. Choose **HTTP API**.
![Cognito flow](/fcj-workshop-Hoangthanhhai/images/5-Workshop/service-image/2.671.png)
