...
- Phát triển tính năng Real-time (Godot & AWS WebSockets): Áp dụng mô hình kết nối WebSockets qua Cloud để làm các tính năng cần tương tác tức thời: game đa người chơi, hệ thống Chat, Notification hoặc Dashboard cập nhật dữ liệu thời gian thực

### Trải nghiệm trong event
- Tham gia event rất bổ ích, giúp tôi có thêm kiến thức, cái nhìn toàn diện về công việc trong tương lai, và có cái nhìn tổng quát về môi trường đi làm sau này
